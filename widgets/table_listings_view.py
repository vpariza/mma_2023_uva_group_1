...
if __name__ == '__main__': 
    ...
    class MainWindow(QtWidgets.QMainWindow):
        ...
        def __init__(self):
            ...
            self.model = TableListingsModel(data.iloc[-100:], imgs_dir_path='/Users/valentinospariza/Library/CloudStorage/OneDrive-UvA/Documents - Multimedia Analytics/Datasets/Funda/images')
            self.table = TableListingsView(self.model)
            self.table.entriesSelected.connect(
                self.on_entriesSelectionChanged
            )
            self.table.entryClicked.connect(
